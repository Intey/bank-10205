...
urlpatterns = [
    ...
    # api calls
    url(r'^api/events/',             include('backend.api.event.urls')),
    url(r'^api/transactions/',       include('backend.api.transaction.urls')),
    url(r'^api/users/',              include('backend.api.user.urls')),
    url(r'^api/auth/',               include('backend.api.auth.urls')),
    url(r'^api/balance/',            include('backend.api.balance.urls')),
]
